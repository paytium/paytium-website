...
const routes = [
  { path: "/", lang: "fr", alternate: "/en", title: "Paytium Maroc | Conseil IT & transformation digitale", description: "Cabinet de conseil et d’ingénierie digitale à Casablanca : stratégie IT, logiciels sur mesure, Data & IA, Cloud, DevOps et facturation électronique.", keywords: "Paytium, Paytium Maroc, cabinet conseil IT Maroc, transformation digitale Maroc, développement logiciel Maroc, Data IA Maroc, Cloud DevOps Maroc" },
  { path: "/en", lang: "en", alternate: "/", title: "Paytium Morocco | IT consulting & digital engineering", description: "IT consulting and digital engineering company in Casablanca for strategy, custom software, Data & AI, Cloud, DevOps and e-invoicing.", keywords: "Paytium, Paytium Morocco, IT consulting company Morocco, digital transformation Morocco, custom software Morocco, Data AI Morocco, Cloud DevOps Morocco" },
  { path: "/services", lang: "fr", alternate: "/en/services", title: "Cabinet conseil IT & transformation digitale Maroc | Paytium", description: "Paytium, cabinet de conseil IT à Casablanca : transformation digitale, développement logiciel, Data & IA, intégration ERP/API, Cloud, DevOps et DevSecOps.", keywords: "services Paytium, cabinet conseil IT Maroc, ESN Maroc, transformation digitale Maroc, développement logiciel sur mesure Maroc, intégration ERP API, Data IA Maroc, Cloud DevOps Maroc, DevSecOps" },
  { path: "/en/services", lang: "en", alternate: "/services", title: "IT consulting & digital transformation Morocco | Paytium", description: "Paytium is an IT consulting and engineering company in Casablanca for digital transformation, custom software, Data & AI, ERP/API integration, Cloud and DevOps.", keywords: "Paytium services, IT consulting company Morocco, digital transformation company Morocco, custom software development Morocco, ERP API integration, Data AI Morocco, Cloud DevOps Morocco" },
