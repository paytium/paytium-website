...
const blogRoutes = [
  ...
  ...blogArticles.flatMap((article) => [
    { path: `/blog/${article.slug}`, lang: "fr", alternate: `/en/blog/${article.slug}`, title: `Paytium | ${article.metaTitle?.fr || article.title.fr}`, breadcrumb: article.title.fr, description: article.metaDescription?.fr || article.summary.fr, keywords: (article.tags?.fr || [article.theme.fr, "Paytium Insights"]).join(", "), socialImage: article.image, socialImageAlt: article.imageAlt.fr, article },
    { path: `/en/blog/${article.slug}`, lang: "en", alternate: `/blog/${article.slug}`, title: `Paytium | ${article.metaTitle?.en || article.title.en}`, breadcrumb: article.title.en, description: article.metaDescription?.en || article.summary.en, keywords: (article.tags?.en || [article.theme.en, "Paytium Insights"]).join(", "), socialImage: article.image, socialImageAlt: article.imageAlt.en, article },
  ]),
];
