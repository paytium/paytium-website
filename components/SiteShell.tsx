    ...
    <>
      ...
      <header className={`site-header ${scrolled ? "is-scrolled" : ""}`} id="top">
        ...
        <nav className="desktop-nav" aria-label={copy.nav}>
          ...
          <a className={activeNav === "blog" ? "active" : undefined} aria-current={activeNav === "blog" ? "page" : undefined} href={`${prefix}/blog/`}>{copy.blog}</a>
        </nav>
      ...
      <aside className={`mobile-drawer ${open ? "open" : ""}`} id="mobile-menu" aria-hidden={!open}>
        ...
        <nav aria-label={copy.nav}>
          ...
          <a className={activeNav === "blog" ? "active" : undefined} aria-current={activeNav === "blog" ? "page" : undefined} href={`${prefix}/blog/`} onClick={() => setOpen(false)}>{copy.blog}</a>
        </nav>
