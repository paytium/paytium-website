...
import { LuArrowLeft, LuArrowRight, LuBadgeCheck, LuBriefcaseBusiness, LuCalendarRange, LuClipboardList, LuCloudCog, LuCode, LuDatabase, LuGauge, LuNetwork, LuPackageOpen, LuRefreshCw, LuShieldCheck, LuSparkles, LuTestTube, LuUsers } from "react-icons/lu";
...
function HeroVisual({ type, locale }: { type: string; locale: "fr" | "en" }) {
  ...
  return <div className="hero-diagram agile-delivery-diagram"><div className="scrum-map"><div className="scrum-route route-main" aria-hidden="true"><i/><i/><i/><i/></div><div className="scrum-route route-return" aria-hidden="true"><i/><i/><i/></div><div className="scrum-node scrum-backlog"><LuClipboardList aria-hidden="true"/><b>{locale === "fr" ? "Backlog produit" : "Product backlog"}</b><small>{locale === "fr" ? "Besoins priorisés" : "Prioritised needs"}</small></div><div className="scrum-node scrum-planning"><LuRefreshCw aria-hidden="true"/><b>Sprint Planning</b><small>{locale === "fr" ? "Objectif du sprint" : "Sprint goal"}</small></div><div className="scrum-node scrum-sprint-backlog"><LuCalendarRange aria-hidden="true"/><b>{locale === "fr" ? "Backlog sprint" : "Sprint backlog"}</b><small>{locale === "fr" ? "Travaux sélectionnés" : "Selected work"}</small></div><div className="scrum-team"><div className="daily-scrum">Daily<br/>Scrum</div><div className="scrum-team-ring"><span><i/><b>DEV</b></span><span><i/><b>UX</b></span><span><i/><b>QA</b></span><span><i/><b>PO</b></span><span><i/><b>SM</b></span><small>{locale === "fr" ? "ÉQUIPE DELIVERY" : "DELIVERY TEAM"}</small></div></div><div className="scrum-node scrum-increment"><LuPackageOpen aria-hidden="true"/><b>{locale === "fr" ? "Incrément livré" : "Product increment"}</b><small>Build · Test · Deploy</small></div><div className="scrum-node scrum-review"><LuBadgeCheck aria-hidden="true"/><b>Sprint Review</b><small>{locale === "fr" ? "Démo & feedback" : "Demo & feedback"}</small></div><div className="scrum-node scrum-retro"><LuRefreshCw aria-hidden="true"/><b>Sprint Retrospective</b><small>{locale === "fr" ? "Amélioration continue" : "Continuous improvement"}</small></div></div></div>;
}
