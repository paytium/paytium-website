...
export default function AcademyPage() {
  return <PageShell locale="en" translationHref="/academy/">
    ...
    <section className="section academy-catalog-section" id="catalog"><SectionHeading eyebrow="CATALOGUE" title={<>Find the course that fits <em>your priorities.</em></>} text="Filter the catalogue by domain, type or format, or search directly for a topic or technology." /><AcademyCatalog locale="en" /></section>
