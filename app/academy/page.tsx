...
export default function AcademyPage() {
  ...
  return <PageShell translationHref="/en/academy">
    ...
    <Breadcrumbs items={[{ label: "Academy", href: "/academy" }]} sections={{ catalogue: "Catalogue des formations" }} />
    ...
    <section className="section academy-catalog-section" id="catalogue"><SectionHeading eyebrow="CATALOGUE" title={<>Trouvez la formation adaptée à <em>vos priorités.</em></>} text="Filtrez le catalogue par domaine, type ou format, ou recherchez directement un sujet ou une technologie." /><AcademyCatalog /></section>
